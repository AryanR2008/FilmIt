...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    private int requestCodeForIntent = 2000;
            ...
            case R.id.btnShareImage:
                if (receivedImageBitmap != null) {
                    if (edtDescription.getText().toString().equals("")) {
                        FancyToast.makeText(getContext(), "You must enter a description for the picture",
                    ...
                    FancyToast.makeText(getContext(),
                            "There is no image selected. Please select an image...",
                            FancyToast.LENGTH_LONG, FancyToast.INFO,
                            false).show();
                }
                break;
    ...
    private void getChosenImage() {
        ...
        startActivityForResult(intent, requestCodeForIntent);
    }
    ...
    public void onActivityResult(int requestCode,
        ...
        if (requestCode == requestCodeForIntent) {
